with source as (
    ...
    select *
    from {{ source('raw_immigration_economy', 'raw_statistics_canada_labour_force_characteristics') }}
...
renamed as (
    ...
    select
        ...
        labour_force_characteristics as labour_force_characteristic,
        gender,
        age_group,
        statistics as labour_market_statistic,
        data_type as labour_market_data_type,

        -- Measures
        safe_cast(value as numeric) as labour_force_value,
