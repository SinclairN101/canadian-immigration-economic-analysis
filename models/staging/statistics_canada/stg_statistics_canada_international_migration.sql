with source as (
    ...
    select *
    from {{ source('raw_immigration_economy', 'raw_statistics_canada_international_migration') }}
...
renamed as (
    ...
    select
        ...
        components_of_population_growth as population_growth_component,

        -- Measures
        safe_cast(value as numeric) as migration_value,
